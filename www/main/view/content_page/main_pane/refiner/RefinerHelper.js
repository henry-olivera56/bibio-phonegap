		...
		ModelHelper, DateUtil, ModelAssist, iScroll)
{
	...
	var helper = {		
		...
		externalSelection : function(rItem, type)
		{			
			var $this = $('.setHeader', "#contentPage #contentBody #mainPane #refiner #lCol #" + type);
			onHeaderClickHandler($this, false);
			setHashValues(rItem);			
			onItemClick(rItem);
			resetAllScrolls();
		}
