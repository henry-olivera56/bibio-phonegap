...
function(IchUtil, AppUtil, TagItemHTML, TagSuggestions, AppEnum, ModelAssist, iScroll, model, cache, TextUtil)
{
	...
	{
		var selectedVPItems = $("#contentBody #mainPane #rDiv #viewPaneWrapper #viewPane #viewPaneItems .vpItem.selected");
